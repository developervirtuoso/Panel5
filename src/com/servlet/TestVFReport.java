...
/**
 * Servlet implementation class TestVFReport
 */
@WebServlet("/TestVFReport")
public class TestVFReport extends HttpServlet {
...
/////////////////////new code ends///////////////////////////////////////////////////
    		...
    		smpp_DaoImpl.sendVFTestMail(request.getParameter("to_email"),request.getParameter("cc_email"),"Daily Traffic Test Report",txt_msg,todaydate.minusDays(1).toString());
          int j=smpp_DaoImpl.insertDailyReportRecord(java.time.LocalDate.now().toString(),"yes");
          if(j>0) {
				response.sendRedirect("ValueFirstEmail.jsp?message=8");

          }else {
				response.sendRedirect("ValueFirstEmail.jsp?message=9");
