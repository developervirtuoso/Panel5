...
<div style="overflow-x:auto;" id="data">
  <table>
    ...
    List<Campaign_data> cd=daoImpl.getCampaignData2(requested_date, requested_date,dateFormat.format(cal.getTime()).toString());
    long SUB=0;
	long DEL=0;
	long percentage=0;
	long Pending=0;
	...
	percentage=(DEL*100)/(SUB);
 	long lastcount=daoImpl.lastSubCountForCampaign2();
